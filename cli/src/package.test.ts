...
describe('package.json configuration', () => {
  ...
  describe('bin configuration', () => {
    it('has hotseat command configured', () => {
      expect(packageJson.bin).toBeDefined();
      expect(packageJson.bin.hotseat).toBe('dist/cli/index.js');
    });

    it('bin points to dist directory', () => {
      expect(packageJson.bin.hotseat).toMatch(/^dist\//);
    });
  });
...
describe('README.md', () => {
  ...
  it('has a title', () => {
    expect(readmeContent).toMatch(/^# Hotseat CLI/m);
  });

  it('explains what Hotseat is', () => {
  ...
  describe('usage section', () => {
    ...
    it('shows basic usage example', () => {
      expect(readmeContent).toMatch(/hotseat ".*"/);
    });
  ...
  describe('output documentation', () => {
    ...
    it('shows output directory', () => {
      expect(readmeContent).toContain('./hotseat/');
    });
  });
