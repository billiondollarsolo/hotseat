/**
 * Error Recovery System for Hotseat CLI
...
export class InterviewError extends Error {
  ...
  getRecoveryInstructions(): string {
    ...
    const instructions: Record<ErrorCategory, string> = {
      network: 'Your progress has been saved. Run "hotseat --resume" to continue where you left off.',
      provider: 'Your progress has been saved. Run "hotseat --resume" to continue where you left off.',
      process: 'Your progress has been saved. Run "hotseat --resume" to continue where you left off.',
      state: 'Please check disk space and file permissions, then try again.',
      validation: 'Please check your input and try again.',
      timeout: 'Your progress has been saved. Run "hotseat --resume" to continue where you left off.',
      user_cancelled: 'Your progress has been saved. Run "hotseat --resume" to continue where you left off.',
      unknown: 'Your progress may have been saved. Run "hotseat --resume" to attempt to continue.',
    };
