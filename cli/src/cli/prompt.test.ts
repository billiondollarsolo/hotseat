...
describe('prompt', () => {
  ...
  describe('renderWelcomeBanner', () => {
    it('renders welcome banner with feature and provider', () => {
      ...
      expect(console.log).toHaveBeenCalledWith(
        expect.stringContaining('Hotseat')
      );
      expect(console.log).toHaveBeenCalledWith(
  ...
  describe('renderCompletionBanner', () => {
    it('renders completion banner with slug and paths', () => {
      renderCompletionBanner('feature-name', './hotseat/feature-name.md', './hotseat/feature-name.json');
      expect(console.log).toHaveBeenCalledWith(
      ...
      expect(console.log).toHaveBeenCalledWith(
        expect.stringContaining('./hotseat/feature-name.md')
      );
      expect(console.log).toHaveBeenCalledWith(
        expect.stringContaining('./hotseat/feature-name.json')
      );
    });

    it('handles missing JSON path', () => {
      renderCompletionBanner('test-slug', './hotseat/test-slug.md');
      expect(console.log).toHaveBeenCalledWith(
