...
allowed-tools: ["Bash(${CLAUDE_PLUGIN_ROOT}/scripts/setup-hotseat.sh:*)", "AskUserQuestion", "Read", "Write", "Glob", "Grep"]
hide-from-slash-command-tool: "true"
---

# Hotseat Plan Command

Execute the setup script to initialize the specification interview:

```!
"${CLAUDE_PLUGIN_ROOT}/scripts/setup-hotseat.sh" $ARGUMENTS
```
